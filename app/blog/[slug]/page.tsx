...
import { getBlogPostBySlug, getPublishedBlogPosts } from "@/app/admin/blogActions";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    if (!post) return {};
    return {
      title: post.metaTitle || `${post.title} - Blog PAS HVAC`,
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <article className="w-full lg:w-2/3 xl:w-[70%]">
              ...
              <nav className="flex items-center gap-2 text-xs font-bold text-neutral-400 uppercase tracking-widest mb-8">
                ...
                <span>/</span>
                <span className="text-primary">{post.category || "Insight"}</span>
              </nav>
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-4 text-sm font-bold text-neutral-500 uppercase tracking-widest border-b border-neutral-200 pb-8">
                  ...
                  {publishedDate && post.readTime && <span className="w-1.5 h-1.5 rounded-full bg-neutral-300" />}
