        ...
        <section className="py-20 relative overflow-hidden bg-primary mt-10">
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={`https://wa.me/6285880006888?text=${encodeURIComponent("Halo PAS HVAC, saya ingin konsultasi gratis mengenai kebutuhan HVAC saya.")}`} target="_blank" rel="noopener noreferrer" 
